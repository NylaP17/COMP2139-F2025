...
namespace COMP2139_ICE.Area.ProjectManagement.Controllers;
...
public class ProjectTaskController : Controller
{
   ...
   private readonly ApplicationDbContext _context; 
    ...
    { 
        ...
        var tasks = _context.ProjectTask 
    ...
    { 
        ...
        var task = _context.ProjectTask.Find(projectTaskId); 
...
// GET: ProjectTasks/Search/{projectId?}/{searchString?}
    ...
    public async Task<IActionResult> Search(int? projectId, string searchString)
    {
        ...
        var taskQuery = _context.ProjectTask.AsQueryable();
